...
// Hindi Ch.1 — Kshitij Bhag-2, "सूरदास" (4 पद from Surdas's भ्रमरगीत, jhks101.pdf,
// read in full — 9 pages). Second subject built with real Language/
// composition content. Course A (Kshitij + Kritika) assumed over Course B
// (Sparsh + Sanchayan) since it's the more widely taught CBSE Hindi option —
// a real, documented assumption, not a silent default; switch is easy if
// the school actually teaches Course B.
//
// Rule-3b inventory:
//  - प्रश्न-अभ्यास Q1-12 (comprehension/interpretation) — BUILT
//    (hindi-surdas-prashn-abhyas), analytical shape
//  - रचना और अभिव्यक्ति Q13-15 (creative/expression) — BUILT
//    (hindi-surdas-rachna-abhivyakti), analytical shape
//  - EXCLUDED, with reason: पाठेतर सक्रियता's two activities (compile an
//    album of witty real/fictional characters like Birbal/Tenali Raman;
//    sing Surdas's padas to a tune) are personalised, open-ended real
//    activities with no fixed grounding to grade against — same exclusion
//    class as every other subject's personalised questions (rule 0b)
const HINDI_SURDAS_PRASHN_ABHYAS_PROBLEMS: PracticeProblem[] = [
  {
    id: "hindi-surdas-q1",
    label: "प्रश्न 1",
    questionText: "गोपियों द्वारा उद्धव को भाग्यवान कहने में क्या व्यंग्य निहित है?",
    analytical: {
      criteria: [
        "पहचानता है कि 'भाग्यवान' कहना वास्तव में व्यंग्य/ताना है, प्रशंसा नहीं",
        "बताता है कि उद्धव प्रेम के बंधन से अछूते (अपरस) हैं, इसलिए गोपियों की दृष्टि में वे सच में भाग्यशाली नहीं बल्कि प्रेम-रस से वंचित हैं — जो प्रेम को महसूस ही नहीं कर सकता, वह अभागा है, भाग्यवान नहीं",
      ],
      groundingNotes:
        "पद (1): 'ऊधौ, तुम हौ अति बड़भागी। अपरस रहत सनेह तगा तें, नाहिन मन अनुरागी।' — गोपियाँ उद्धव के प्रेम-निर्लिप्त होने को ही व्यंग्य में 'सौभाग्य' कह रही हैं।",
    },
    verifyLine: "एक सत्यापित उत्तर व्यंग्य को सही पहचानता है — निर्लिप्तता को 'भाग्य' कहना असल में आलोचना है ✓",
  },
  {
    id: "hindi-surdas-q2",
    label: "प्रश्न 2",
    questionText: "उद्धव के व्यवहार की तुलना किस-किस से की गई है?",
    analytical: {
      criteria: [
        "कमल के पत्ते से तुलना बताता है (पानी में रहकर भी नहीं भीगता)",
        "तेल के घड़े/गागर से तुलना बताता है (पानी में डूबे रहने पर भी पानी नहीं समाता)",
      ],
      groundingNotes:
        "'पुरइनि पात रहत जल भीतर, ता रस देह न दागी। ज्यौं जल माँह तेल की गागरि, बूँद न ताकौं लागी।'",
    },
    verifyLine: "दोनों वास्तविक उपमाएँ (कमल पत्ता, तेल की गागर) सही पहचानी गईं ✓",
  },
  {
    id: "hindi-surdas-q3",
    label: "प्रश्न 3",
    questionText: "गोपियों ने किन-किन उदाहरणों के माध्यम से उद्धव को उलाहने दिए हैं?",
    analytical: {
      criteria: [
        "कमल पत्ते और तेल की गागर के उदाहरण बताता है — उद्धव की निर्लिप्तता पर ताना",
        "चींटी के गुड़ में लिपटने के उदाहरण को भी बताता है — गोपियों की अपनी सच्ची अनुरक्ति दिखाने के लिए, उद्धव के विपरीत",
      ],
      groundingNotes:
        "'गुर चाँटी ज्यौं पागी' — 'सूरदास' अबला हम भोरी, गुर चाँटी ज्यौं पागी' — जिस तरह चींटी गुड़ में लिपट जाती है, उसी तरह गोपियाँ कृष्ण-प्रेम में लिपटी हैं, उद्धव की निर्लिप्तता के विपरीत।",
    },
    verifyLine: "तीनों वास्तविक उदाहरण (कमल पत्ता, तेल गागर, चींटी-गुड़) सही पहचाने गए ✓",
  },
  {
    id: "hindi-surdas-q4",
    label: "प्रश्न 4",
    questionText: "उद्धव द्वारा दिए गए योग के संदेश ने गोपियों की विरहाग्नि में घी का काम कैसे किया?",
    analytical: {
      criteria: [
        "बताता है कि गोपियाँ पहले से ही कृष्ण-वियोग में तड़प रही थीं",
        "स्पष्ट करता है कि योग का ज्ञान-भरा संदेश (प्रेम-भरा संदेश नहीं) सुनकर उनकी विरह-वेदना और भड़क उठी, क्योंकि यह उनके प्रेम को नकारने जैसा लगा",
      ],
      groundingNotes:
        "पद (2): 'अब इन जोग सैंदेसनि सुनि-सुनि, बिरहिनि बिरह दही।' — योग का संदेश सुनना ही विरहिणी गोपियों को और अधिक जला रहा है।",
    },
    verifyLine: "एक सत्यापित उत्तर योग-संदेश और बढ़ती विरह-वेदना के बीच सही संबंध बताता है ✓",
  },
  {
    id: "hindi-surdas-q5",
    label: "प्रश्न 5",
    questionText: "'मरजादा न लही' के माध्यम से कौन-सी मर्यादा न रहने की बात की जा रही है?",
    analytical: {
      criteria: [
        "बताता है कि गोपियों के धैर्य/धीरज की सीमा टूट रही है",
        "स्पष्ट करता है कि विरह में इतनी व्याकुलता है कि संयम बनाए रखना असंभव हो गया है",
      ],
      groundingNotes:
        "'सूरदास' अब धीर धरहिं क्यों, मरजादा न लही।' — गोपियाँ कह रही हैं कि अब धैर्य धारण करने की कोई मर्यादा/सीमा शेष नहीं बची।",
    },
    verifyLine: "एक सत्यापित उत्तर सही ढंग से टूटते धैर्य/संयम की मर्यादा की बात करता है ✓",
  },
  {
    id: "hindi-surdas-q6",
    label: "प्रश्न 6",
    questionText: "कृष्ण के प्रति अपने अनन्य प्रेम को गोपियों ने किस प्रकार अभिव्यक्त किया है?",
    analytical: {
      criteria: [
        "हारिल पक्षी की लकड़ी के उदाहरण का उल्लेख करता है (जो कभी नहीं छोड़ता)",
        "बताता है कि मन, वचन और कर्म तीनों से उन्होंने कृष्ण (नंद-नंदन) को हृदय में दृढ़ता से पकड़ रखा है",
        "जागते-सोते, स्वप्न में, दिन-रात कृष्ण का ही नाम रटने का उल्लेख करता है",
      ],
      groundingNotes:
        "पद (3): 'हमारैं हरि हारिल की लकरी। मन क्रम बचन नंद-नंदन उर, यह दृढ़ करि पकरी। जागत सोवत स्वप्न दिवस-निसि, कान्ह-कान्ह जक री।'",
    },
    verifyLine: "हारिल पक्षी की उपमा और मन-वचन-कर्म का उल्लेख सही ढंग से किया गया ✓",
  },
  {
    id: "hindi-surdas-q7",
    label: "प्रश्न 7",
    questionText: "गोपियों ने उद्धव से योग की शिक्षा कैसे लोगों को देने की बात कही है?",
    analytical: {
      criteria: [
        "बताता है कि जिनका मन 'चकरी' जैसा अस्थिर/चंचल है, उन्हें ही योग-संदेश दिया जाए",
        "स्पष्ट करता है कि गोपियों का मन तो अटल कृष्ण-प्रेम में स्थिर है, इसलिए उन्हें योग की आवश्यकता नहीं",
      ],
      groundingNotes:
        "पद (3): 'यह तौ 'सूर' तिनहिं लै सौंपौ, जिनके मन चकरी।' — चकरी अर्थात् जिनका मन स्थिर नहीं रहता।",
    },
    verifyLine: "एक सत्यापित उत्तर सही ढंग से 'चंचल मन वालों' को दर्शाता है, गोपियों को नहीं ✓",
  },
  {
    id: "hindi-surdas-q8",
    label: "प्रश्न 8",
    questionText: "प्रस्तुत पदों के आधार पर गोपियों का योग-साधना के प्रति दृष्टिकोण स्पष्ट करें।",
    analytical: {
      criteria: [
        "बताता है कि गोपियाँ योग को अप्रासंगिक और कड़वा (करुई ककड़ी जैसा) मानती हैं",
        "स्पष्ट करता है कि वे इसे एक अनचाही 'व्याधि' (रोग) के रूप में देखती हैं",
        "निष्कर्ष निकालता है कि योग उनके सहज, गहरे कृष्ण-प्रेम का कोई विकल्प नहीं हो सकता",
      ],
      groundingNotes:
        "पद (3): 'सुनत जोग लागत है ऐसौ, ज्यौं करुई ककरी। सु तौ ब्याधि हमकौं लै आए, देखी सुनी न करी।'",
    },
    verifyLine: "एक सत्यापित उत्तर गोपियों के योग के प्रति नकारात्मक/अस्वीकार्य दृष्टिकोण को सही ढंग से दर्शाता है ✓",
  },
  {
    id: "hindi-surdas-q9",
    label: "प्रश्न 9",
    questionText: "गोपियों के अनुसार राजा का धर्म क्या होना चाहिए?",
    analytical: {
      criteria: [
        "बताता है कि राजा का धर्म प्रजा को कष्ट न पहुँचाना/सताना नहीं है",
        "इसे पद (4) की अंतिम पंक्ति से सीधे जोड़ता है",
      ],
      groundingNotes:
        "पद (4): 'राज धरम तौ यहै 'सूर', जो प्रजा न जाहिं सताए।' — सच्चा राजधर्म प्रजा-हित में है, चाहे राजा कितना भी चतुर/सक्षम क्यों न हो।",
    },
    verifyLine: "एक सत्यापित उत्तर सीधे 'प्रजा न जाहिं सताए' की पंक्ति से जुड़ा है ✓",
  },
  {
    id: "hindi-surdas-q10",
    label: "प्रश्न 10",
    questionText: "गोपियों को कृष्ण में ऐसे कौन-से परिवर्तन दिखाई दिए जिनके कारण वे अपना मन वापस पाने की बात कहती हैं?",
    analytical: {
      criteria: [
        "बताता है कि गोपियाँ व्यंग्य में कहती हैं कि कृष्ण अब राजनीति पढ़ आए हैं — यानी चतुर, स्वार्थी राजनीतिज्ञ बन गए हैं",
        "बताता है कि गोपियाँ व्यंग्य में विश्वास जताती हैं कि कृष्ण जल्दी ही अपना मन फेर लेंगे और पहले जो प्रेम/स्नेह चुराकर ले गए थे, वह भी लौटा देंगे",
      ],
      groundingNotes:
        "पद (4): 'हरि हैं राजनीति पढ़ि आए... अब अपनै मन फेर पाइहैं, चलत जु हुते चुराए।'",
    },
    verifyLine: "एक सत्यापित उत्तर 'राजनीति पढ़ आना' और 'मन फेर पाना' दोनों को सही ढंग से जोड़ता है ✓",
  },
  {
    id: "hindi-surdas-q11",
    label: "प्रश्न 11",
    questionText: "गोपियों ने अपने वाक्चातुर्य के आधार पर उद्धव को परास्त कर दिया, उनके वाक्चातुर्य की विशेषताएँ लिखिए।",
    analytical: {
      criteria: [
        "तीखे व्यंग्य का उल्लेख करता है (जैसे 'भाग्यवान' कहना)",
        "उपयुक्त लौकिक उदाहरणों का उल्लेख करता है (कमल पत्ता, तेल गागर, चींटी-गुड़, हारिल पक्षी, करेला)",
        "तर्कपूर्ण प्रतिवाद का उल्लेख करता है (चंचल-मन वालों को योग भेजने की सलाह देना)",
        "राजधर्म की दुहाई देकर कृष्ण को कठघरे में खड़ा करने की बात करता है",
      ],
      groundingNotes:
        "पूरे चारों पदों में गोपियों का वाक्चातुर्य लौकिक उदाहरणों, व्यंग्य और तार्किक प्रतिवाद के संयोजन से बना है — प्रत्येक पद में एक नई युक्ति है।",
    },
    verifyLine: "एक सत्यापित उत्तर वाक्चातुर्य की कई वास्तविक विशेषताओं का उल्लेख करता है, न कि केवल एक ✓",
  },
  {
    id: "hindi-surdas-q12",
    label: "प्रश्न 12",
    questionText: "संकलित पदों को ध्यान में रखते हुए सूर के भ्रमरगीत की मुख्य विशेषताएँ बताएँ।",
    analytical: {
      criteria: [
        "गहरी वियोग/विरह भावना के चित्रण का उल्लेख करता है",
        "गोपियों की वाक्चातुर्य और व्यंग्य क्षमता का उल्लेख करता है",
        "ज्ञान-मार्ग (योग) और प्रेम/भक्ति-मार्ग के बीच द्वंद्व और तुलना का उल्लेख करता है",
        "लौकिक उदाहरणों के प्रयोग और भक्ति की श्रेष्ठता स्थापित करने का उल्लेख करता है",
      ],
      groundingNotes:
        "चारों पदों का संकलित विश्लेषण — भ्रमरगीत में विरह, वाक्चातुर्य, ज्ञान बनाम भक्ति का द्वंद्व, और लौकिक उपमाएँ सभी मौजूद हैं।",
    },
    verifyLine: "एक सत्यापित उत्तर भ्रमरगीत की कई वास्तविक विशेषताओं को जोड़ता है, न कि सिर्फ एक सामान्य वाक्य ✓",
  },
];

const HINDI_SURDAS_RACHNA_ABHIVYAKTI_PROBLEMS: PracticeProblem[] = [
  {
    id: "hindi-surdas-q13",
    label: "प्रश्न 13 — रचना और अभिव्यक्ति",
    questionText: "गोपियों ने उद्धव के सामने तरह-तरह के तर्क दिए हैं, आप अपनी कल्पना से और तर्क दीजिए।",
    analytical: {
      criteria: [
        "मौलिक तर्क प्रस्तुत करता है (पदों में सीधे न दोहराया गया)",
        "तर्क गोपियों के स्थापित दृष्टिकोण (प्रेम बनाम योग, कृष्ण-भक्ति की श्रेष्ठता) के अनुरूप है",
        "किसी लौकिक/रोज़मर्रा के उदाहरण का उपयोग करता है, जैसा कि असली पदों में किया गया है (कमल पत्ता, तेल गागर जैसी शैली में)",
      ],
      groundingNotes:
        "यह एक खुला, रचनात्मक प्रश्न है — कोई एक निश्चित उत्तर नहीं। ग्रेडिंग इस बात पर केंद्रित है कि क्या नया तर्क वास्तव में मौलिक है और गोपियों की स्थापित भावना/शैली से मेल खाता है, चारों पदों में दिखाए गए वास्तविक तर्क-पैटर्न पर आधारित।",
    },
    verifyLine: "एक सत्यापित उत्तर मौलिक तर्क देता है जो गोपियों की स्थापित आवाज़/शैली से मेल खाता है ✓",
  },
  {
    id: "hindi-surdas-q14",
    label: "प्रश्न 14 — रचना और अभिव्यक्ति",
    questionText: "उद्धव ज्ञानी थे, नीति की बातें जानते थे; गोपियों के पास ऐसी कौन-सी शक्ति थी जो उनके वाक्चातुर्य में मुखरित हो उठी?",
    analytical: {
      criteria: [
        "बताता है कि गोपियों की शक्ति उनका सच्चा, गहरा भक्ति-प्रेम था — शास्त्रीय ज्ञान नहीं",
        "स्पष्ट करता है कि यह प्रेम की तीव्रता ही थी जिसने उनके लौकिक उदाहरणों को इतना तीखा और प्रभावी बना दिया",
        "बताता है कि एक विद्वान (उद्धव) भी इस भावनात्मक/अनुभवजन्य तर्क के आगे निरुत्तर हो गया",
      ],
      groundingNotes:
        "चारों पदों में गोपियों का तर्क शास्त्रीय ज्ञान से नहीं बल्कि अपने वास्तविक, गहन प्रेम-अनुभव और रोज़मर्रा के जीवन के उदाहरणों से निकला है — यही उनकी असली शक्ति है।",
    },
    verifyLine: "एक सत्यापित उत्तर सही ढंग से भक्ति-प्रेम की तीव्रता को गोपियों की वास्तविक शक्ति बताता है ✓",
  },
  {
    id: "hindi-surdas-q15",
    label: "प्रश्न 15 — रचना और अभिव्यक्ति",
    questionText: "गोपियों ने यह क्यों कहा कि हरि अब राजनीति पढ़ आए हैं? क्या आपको गोपियों के इस कथन का विस्तार समकालीन राजनीति में नज़र आता है, स्पष्ट कीजिए।",
    analytical: {
      criteria: [
        "बताता है कि गोपियाँ व्यंग्य में यह कह रही हैं कि सत्ता/स्थिति बदलने पर कृष्ण का व्यवहार भी बदल गया है — अब वे सीधे प्रेम-भरे संदेश की बजाय कूटनीतिक चाल (योग-संदेश) भेज रहे हैं",
        "समकालीन राजनीति से एक वास्तविक, तर्कसंगत संबंध बनाता है — जैसे सत्ता में आने पर व्यक्तिगत/भावनात्मक संबंधों पर स्वार्थ और रणनीति हावी होना",
        "यह एक खुला विचार-प्रश्न है, इसलिए ग्रेडिंग किसी एक निश्चित उत्तर पर नहीं बल्कि तर्क की गुणवत्ता और पद के मूल आशय से जुड़ाव पर आधारित है",
      ],
      groundingNotes:
        "पद (4) का पूरा संदर्भ 'राजनीति' के व्यंग्यात्मक प्रयोग पर आधारित है — गोपियाँ कृष्ण की कूटनीतिक चतुराई की आलोचना कर रही हैं। यह एक खुला, विचारोत्तेजक प्रश्न है जिसका कोई एक निश्चित उत्तर नहीं।",
    },
    verifyLine: "एक सत्यापित उत्तर पद के व्यंग्य को सही ढंग से समझाता है और एक तर्कसंगत समकालीन उदाहरण जोड़ता है ✓",
  },
];
...
export const PRACTICE_SETS: Record<string, PracticeProblem[]> = {
  ...
  "hindi-surdas-prashn-abhyas": HINDI_SURDAS_PRASHN_ABHYAS_PROBLEMS,
  "hindi-surdas-rachna-abhivyakti": HINDI_SURDAS_RACHNA_ABHIVYAKTI_PROBLEMS,
};
...
const TOPIC_TITLES: Record<string, string> = {
  ...
  "hindi-surdas-prashn-abhyas": "प्रश्न-अभ्यास",
